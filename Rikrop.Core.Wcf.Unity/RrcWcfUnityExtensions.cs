...
namespace Rikrop.Core.Wcf.Unity
{
    public static class RrcWcfUnityExtensions
    {
        ...
        /// </summary>
        public static IUnityContainer RegisterWcfHosting(this IUnityContainer container, string serviceIp, int servicePort, IReadOnlyCollection<Type> serviceBehaviors)
        {
        ...
        /// </summary>
        public static IUnityContainer RegisterWcfErrorHandlers(this IUnityContainer container, IReadOnlyCollection<Type> errorHandlers)
        {
